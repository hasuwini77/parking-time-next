...
Min e-post: "${userEmail}"`;
  ...
  return (
    <div className="bg-primary flex-col flex w-full items-center justify-between py-8 px-2 text-center">
      ...
      <h2 className="text-heading2 my-4 text-bold text-textColor">
      ...
      <div className="sm:relative w-[360px] text-textColor sm:w-[420px] flex-col sm:flex-row items-center justify-center mt-3 max-w-[98%]">
        <form onSubmit={onSubmit}>
          <input
            ...
            className="sm:pe-32 ps-2 pe-2 py-[12px] w-full rounded-[40px] mb-2 sm:mb-0 text-primary focus-visible:outline-primary"
          />
          <button
            type="submit"
            className="sm:w-[110px] w-[360px] max-w-[98%] py-[14px] sm:py-[6px] rounded-[40px] text-center sm:absolute text-base sm:text-[12px] sm:right-[10px] sm:top-[6px] sm:rounded-[20px] bg-black text-white hover:bg-[#d2cfcf] hover:text-black hover:border"
          >
