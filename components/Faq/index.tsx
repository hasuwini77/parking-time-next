...
const Faq: React.FC = () => {
    ...
    const myEngContent: AccordionContent = { 
        ...
        Accordion1: "Parking Time allows you to fully take your parking slot to the next level. You will be sure that you get a fine spot while respecting the law!",
        Accordion2Title: "How do I use Parking Time?",
        Accordion2: "You go into your App Store or Google Play store and search for Parking Time, download the app. You can also get started by visiting parkingtime.se",
        Accordion3Title: "Is it free?",
        Accordion3: "Yes of course, it is free to use!",
        Accordion4Title: "How do I get it in my municipality?",
        Accordion4: "Please contact the authorities within your commune or region for more information.",
        Accordion5Title: "Known problems with the app",
        Accordion5: "At this moment, we are unaware of any issues with our App. It's as perfect as it can be!"
    };

    const mySweContent: AccordionContent = { 
        Accordion1Title: "Vad är Parking Time?",
        Accordion1: "Parking Time låter dig utnyttja din parkeringsplats till fullo. Du kommer att vara säker på att du får en bra plats samtidigt som du respekterar lagen!",
        Accordion2Title: "Hur använder jag Parking Time?",
        Accordion2: "Gå in i din App Store eller Google Play butik och sök efter Parking Time, ladda ner appen. Du kan också komma igång genom att besöka parkingtime.se",
        ...
        Accordion4: "Kontakta myndigheterna inom din kommun eller region för mer information.",
        Accordion5Title: "Kända problem med appen",
        Accordion5: "För tillfället är vi inte medvetna om några problem med vår app. Den är så perfekt som den kan vara!"
    };
    ...
    return (
        <>
            <div className="container w-full min-w-full py-28 md:py-38 px-4 md:px-20 flex flex-col justify-center items-center text-center">
                ...
                <p className="m-0 py-2 text-paragraph1"> {language === "english" ? "Feel free to contact us if you have any questions." : "Kontakta oss gärna om du har några frågor."}</p>
