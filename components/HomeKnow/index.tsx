...
const HomeKnow: React.FC = () => {
    ...
    return (
        <div className="bg-primary flex flex-col items-center justify-center text text-darkblue1 md:flex-row">
            <div className="mt-12 w-full max-w-80 m-2.5 flex flex-col justify-center items-center p-2 text-center md:flex-1 md:max-w-none md:pt-6 md:pb-12">
                ...
                {language === "english" ? (
                    ...
                    <span className="text-white text-base"><a href="mailto:Matilda@parkingtime.se">Matilda@parkingtime.se</a></span>
            </div>
            <div className="w-full max-w-80 m-2.5 flex flex-col justify-center items-center p-1 text-center mb-12 md:items-start md:text-left md:pt-5 md:flex-1 md:max-w-none md:pb-12">
                {language === "english" ? (
                    <span className="text-white text-4xl font-semibold pb-3 md:text-[44px] md:pt-4 md:pb-5 md:pr-3">
                ...
                {language === "english" ? (
                    <span className="text-white text-base pb-1 md:max-w-[400px]">
