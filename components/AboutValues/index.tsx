  ...
  return (
        ...
        <section className="flex justify-center items-center w-full flex-col md:flex-col md:w-full md:items-center py-20">
                ...
                <p className="md:max-w-[200px]">
                        Vi strävar efter att skapa enkla och smidiga upplevelser.</p>
                </span>
                    )}
                </div>
                ...
                <p className="md:max-w-[200px]">Always trying to improve and making our app a leader in its field.
                </p>
                </span>
                ) : (
                <span className="text-center flex flex-col items-center justify-start  w-full md:flex-col md:m-2.5 h-[140px] ">
                ...
                <p className="md:max-w-[200px]">It&apos;s crucial that our service meets users&apos; needs and enhances their parking experience.
                </p>
                </span>
                ) : (
                <span className="text-center flex flex-col items-center justify-start w-full md:flex-col h-[140px] ">
                <b className="text-xl">Användarvänlig</b>
                <p className="md:max-w-[200px]">Det är avgörande att vår tjänst möter användarnas behov och förbättrar deras parkeringsupplevelse.
                </p>
                </span>
                )}
                </div>
