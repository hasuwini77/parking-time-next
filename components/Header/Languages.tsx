  ...
  return (
    ...
    >
      <button onClick={toggleDropdown} className="flex items-center">
        <span className="w-[50px] h-[20px] text-[14px] text-start font-bold md:ms-1 me-[-3px]">
      ...
      <motion.div
        ...
        className="absolute top-[40px] left-[-12px] bg-primary w-[100px] rounded-b-lg px-1 py-1"
      >
        <motion.ul>
          {languages.map((item) => (
            <motion.li
