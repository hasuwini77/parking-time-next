...
const HomeHowWorks = () => {
  ...
  return (
    <div className=" w-full py-32 sm:py-44 px-4 sm:px-20 flex flex-col justify-between items-center ">
      ...
      <div className="flex flex-col flex-wrap justify-center sm:justify-between items-center middleWidth:flex-row ">
        <CardHowWorks
          ...
          icon="FaEdit"
        />
        <FaArrowRight className=" rotate-90 middleWidth:rotate-0 my-4 sm:mx-3 text-red" size={30} />
        <CardHowWorks
