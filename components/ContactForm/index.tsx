  ...
  return (
    <section className="xl:gap-10 md:py-7 xl:max-w-7xl lg:max-w-3xl md:max-w-2xl mx-auto flex flex-col xl:flex-row items-center pt-5 pb-4">
        <div className="p-4 self-start">
            ...
            <p className="mb-4 font-mono text-base leading-8 font-[500]">Whether you have a question, feedback, or need assistance, please fill out the form below, and our team will get back to you as soon as possible.</p>
        ...
        <div className="container mx-auto p-4 rounded-lg">
          ...
          <DownloadButton linkHref="/contact" SWtext="Skicka meddelande" ENtext="Send message" />
        </div>
    </section>
  )
}
