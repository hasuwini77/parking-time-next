...
const ContactForm: FC = () => {
  ...
  return (
    <section
      className={
        theme === "dark"
          ? "bg-background text-textColor xl:gap-10 md:py-7 xl:max-w-7xl lg:max-w-3xl md:max-w-2xl mx-auto flex flex-col xl:flex-row items-center pt-5 pb-4"
          : "xl:gap-10 md:py-7 xl:max-w-7xl lg:max-w-3xl md:max-w-2xl mx-auto flex flex-col xl:flex-row items-center pt-5 pb-4"
      }
    >
      <div className="p-4 xl:p-5 self-start">
        ...
        <ul className="list-none">
          <li className="mb-2 flex items-center">
            ...
            <a href="mailto:info@parkingtime.se" className="underline">
              info@parkingtime.se
            </a>
          </li>
          <li className="mb-2 flex items-center">
            <FaPhone className="mr-2" />
            <a href="tel:+46723991515" className="text-blue-600 underline">
              +46 72 399 15 15
            </a>
          </li>
          <li className="mb-2 flex items-center">
          ...
          <div>
            ...
            >
              {language === "english"
                ? "First and last name"
                : "För- och efternamn"}{" "}
              <span className="text-red text-bold text-md">*</span>
            </label>
            <input
              type="text"
              id="name"
