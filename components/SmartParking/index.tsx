...
const SmartParking: React.FC = () => {
  ...
  return (
    <section
      className={theme === "dark" ? "md:py-8 bg-secondary" : "md:py-8 bg-white"}
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center pt-5 pb-4">
        ...
        <div className="px-3 md:w-1/2">
          <div className="max-w-xl">
            <h1 className="font-bold text-textColor text-4xl md:text-heading2 mb-3">
              {language === "english"
                ? "Smart Parking Solution"
                : "Smart Parking lösning"}
            </h1>
            <p className="text-base text-textColor mb-4 font-sans">
              {language === "english"
          ...
          <div>
            <ul className="list-none mb-4">
              <li className="font-bold text-textColor text-lg mb-2 flex items-center">
                <img
