    ...
    return (
        ...
        <div className="w-full flex justify-center p-2 md:hidden">
            ...
            <div className="w-4/5 md:w-3/6">
                {language === "english" ? (                    
                    <span className="text-4xl w-full flex justify-center font-mono md:w-4/5 md:text-heading2">
                        Download now
                    </span>
                ) : (
                    <span className="text-4xl w-full font-mono text-center md:w-4/5 md:justify-center md:text-heading2"> 
                        Ladda Ner Nu!
                    </span>
                )}
                    {language === "english" ? (               
